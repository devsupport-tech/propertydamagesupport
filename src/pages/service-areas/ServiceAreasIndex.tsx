              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                {serviceAreas.tier1.map((city) => (
                  <Link
                    ...
                    className="flex flex-col items-center justify-center p-6 bg-white border border-neutral-200 rounded-xl hover:shadow-lg hover:-translate-y-1 transition-all group"
                  >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                {serviceAreas.tier2.map((city) => (
                  <Link
                    key={city.slug}
                    to={`/service-areas/${city.slug}`}
                    className="flex items-center justify-center p-4 bg-white border border-neutral-200 rounded-lg hover:shadow-md hover:-translate-y-0.5 transition-all group"
                  >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                {[
                  ...
                  <Link
                    key={service.name}
                    to={service.href}
                    className="flex flex-col items-center p-6 bg-white border border-neutral-200 rounded-xl hover:shadow-lg hover:-translate-y-1 transition-all group"
                  >
