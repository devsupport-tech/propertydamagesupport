      ...
      <section className="py-20 px-6">
        <div className="container max-w-4xl mx-auto">
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-cbrs-primary mt-12 mb-4">1. Information We Collect</h2>

            <h3 className="text-xl font-semibold text-cbrs-primary mt-6 mb-3">Personal Information</h3>
            ...
            <h3 className="text-xl font-semibold text-cbrs-primary mt-6 mb-3">Automatically Collected Information</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h2 className="text-2xl font-bold text-cbrs-primary mt-12 mb-4">2. How We Use Your Information</h2>
            ...
            <h2 className="text-2xl font-bold text-cbrs-primary mt-12 mb-4">3. Information Sharing and Disclosure</h2>
            ...
            <h2 className="text-2xl font-bold text-cbrs-primary mt-12 mb-4">4. Data Security</h2>
            ...
            <h2 className="text-2xl font-bold text-cbrs-primary mt-12 mb-4">5. Cookies and Tracking Technologies</h2>
            ...
            <h2 className="text-2xl font-bold text-cbrs-primary mt-12 mb-4">6. Your Privacy Rights</h2>
            ...
            <p className="text-gray-700 mb-6">
              To exercise these rights, please contact us at <a href={`mailto:${siteConfig.email}`} className="text-cbrs-accent hover:underline">{siteConfig.email}</a>.
            </p>

            <h2 className="text-2xl font-bold text-cbrs-primary mt-12 mb-4">7. Children's Privacy</h2>

            <p className="text-gray-700 mb-6">
              Our services are not directed to individuals under the age of 18. We do not knowingly collect personal information from children. If you believe we have collected information from a child, please contact us immediately.
            </p>

            <h2 className="text-2xl font-bold text-cbrs-primary mt-12 mb-4">8. Third-Party Links</h2>
            ...
            <h2 className="text-2xl font-bold text-cbrs-primary mt-12 mb-4">9. Changes to This Privacy Policy</h2>
            ...
            <h2 className="text-2xl font-bold text-cbrs-primary mt-12 mb-4">10. Contact Us</h2>
            ...
            <div className="mt-12 pt-8 border-t border-gray-300">
              <p className="text-sm text-gray-600 text-center">
                <Link href="/terms" className="text-cbrs-accent hover:underline">View our Terms of Service</Link>
                {' '} | {' '}
