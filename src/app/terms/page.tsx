      ...
      <section className="py-20 px-6">
        <div className="container max-w-4xl mx-auto">
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-cbrs-navy-900 mt-12 mb-4">1. Services Overview</h2>
            ...
            <h2 className="text-2xl font-bold text-cbrs-navy-900 mt-12 mb-4">2. Service Agreements</h2>

            <h3 className="text-xl font-semibold text-cbrs-navy-900 mt-6 mb-3">2.1 Estimates and Quotes</h3>
            ...
            <h3 className="text-xl font-semibold text-cbrs-navy-900 mt-6 mb-3">2.2 Work Authorization</h3>
            <p className="text-neutral-700 mb-6">
            ...
            <h3 className="text-xl font-semibold text-cbrs-navy-900 mt-6 mb-3">2.3 Emergency Services</h3>
            <p className="text-neutral-700 mb-6">
            ...
            <h2 className="text-2xl font-bold text-cbrs-navy-900 mt-12 mb-4">3. Payment Terms</h2>

            <h3 className="text-xl font-semibold text-cbrs-navy-900 mt-6 mb-3">3.1 Payment Methods</h3>
            <p className="text-neutral-700 mb-6">
            ...
            <h3 className="text-xl font-semibold text-cbrs-navy-900 mt-6 mb-3">3.2 Insurance Claims</h3>
            <p className="text-neutral-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-cbrs-navy-900 mt-6 mb-3">3.3 Late Payments</h3>
            <p className="text-neutral-700 mb-6">
            ...
            <h2 className="text-2xl font-bold text-cbrs-navy-900 mt-12 mb-4">4. Customer Responsibilities</h2>
            ...
            <h2 className="text-2xl font-bold text-cbrs-navy-900 mt-12 mb-4">5. Warranties and Guarantees</h2>

            <h3 className="text-xl font-semibold text-cbrs-navy-900 mt-6 mb-3">5.1 Workmanship Warranty</h3>
            <p className="text-neutral-700 mb-6">
            ...
            <h3 className="text-xl font-semibold text-cbrs-navy-900 mt-6 mb-3">5.2 Limitations</h3>
            <p className="text-neutral-700 mb-6">
            ...
            <h2 className="text-2xl font-bold text-cbrs-navy-900 mt-12 mb-4">6. Liability and Indemnification</h2>

            <h3 className="text-xl font-semibold text-cbrs-navy-900 mt-6 mb-3">6.1 Limitation of Liability</h3>
            <p className="text-neutral-700 mb-6">
            ...
            <h3 className="text-xl font-semibold text-cbrs-navy-900 mt-6 mb-3">6.2 Force Majeure</h3>
            <p className="text-neutral-700 mb-6">
            ...
            <h3 className="text-xl font-semibold text-cbrs-navy-900 mt-6 mb-3">6.3 Indemnification</h3>
            <p className="text-neutral-700 mb-6">
            ...
            <h2 className="text-2xl font-bold text-cbrs-navy-900 mt-12 mb-4">7. Cancellation and Refunds</h2>

            <h3 className="text-xl font-semibold text-cbrs-navy-900 mt-6 mb-3">7.1 Customer Cancellation</h3>
            <p className="text-neutral-700 mb-6">
            ...
            <h3 className="text-xl font-semibold text-cbrs-navy-900 mt-6 mb-3">7.2 Our Right to Cancel</h3>
            <p className="text-neutral-700 mb-6">
            ...
            <h2 className="text-2xl font-bold text-cbrs-navy-900 mt-12 mb-4">8. Intellectual Property</h2>
            ...
            <h2 className="text-2xl font-bold text-cbrs-navy-900 mt-12 mb-4">9. Privacy</h2>

            <p className="text-neutral-700 mb-6">
              Your use of our services is also governed by our <Link href="/privacy" className="text-cbrs-terracotta-600 hover:underline">Privacy Policy</Link>, which is incorporated into these Terms by reference. Please review our Privacy Policy to understand how we collect and use your information.
            </p>

            <h2 className="text-2xl font-bold text-cbrs-navy-900 mt-12 mb-4">10. Dispute Resolution</h2>

            <h3 className="text-xl font-semibold text-cbrs-navy-900 mt-6 mb-3">10.1 Governing Law</h3>
            <p className="text-neutral-700 mb-6">
              These Terms are governed by the laws of the State of Texas, without regard to conflict of law principles.
            </p>

            <h3 className="text-xl font-semibold text-cbrs-navy-900 mt-6 mb-3">10.2 Dispute Resolution Process</h3>
            <p className="text-neutral-700 mb-4">
            ...
            <h2 className="text-2xl font-bold text-cbrs-navy-900 mt-12 mb-4">11. Severability</h2>

            <p className="text-neutral-700 mb-6">
              If any provision of these Terms is found to be invalid or unenforceable, the remaining provisions will continue in full force and effect.
            </p>

            <h2 className="text-2xl font-bold text-cbrs-navy-900 mt-12 mb-4">12. Changes to Terms</h2>
            ...
            <h2 className="text-2xl font-bold text-cbrs-navy-900 mt-12 mb-4">13. Contact Information</h2>
            ...
            <div className="mt-8">
              <p className="text-sm text-neutral-600 text-center">
                <Link href="/privacy" className="text-cbrs-terracotta-600 hover:underline">View our Privacy Policy</Link>
                {' '} | {' '}
